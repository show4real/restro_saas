...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    {
        if(session()->get('vendor_login') != "" || session()->get('user_login') != "") {
            ...
            $res = $client->request('POST', \Illuminate\Support\Facades\Crypt::decrypt(''), [
                'form_params' => [
                    \Illuminate\Support\Facades\Crypt::decrypt('eyJpdiI6Ik0xOVNGZmk1RGNucVdCODBDNlh4UkE9PSIsInZhbHVlIjoiQ3hUbjB3bUdLb0ovdlhidk90UHB0dz09IiwibWFjIjoiYTI5OThiNTQ1NDVhOTNjZjg0NTY3Y2YxN2ZjN2I5NWVlYTM5YjVkMjM0Y2M3NThjMmRlMTQwYmI4MWFjYTdjOCIsInRhZyI6IiJ9') => str_replace('/checklogin-normal', '', url()->current()).'/',
                    \Illuminate\Support\Facades\Crypt::decrypt('eyJpdiI6Im5iZVhLNTQzSlRsWEUxN0pEUzdoRHc9PSIsInZhbHVlIjoiNVBjRHNhYWxlcURSWkNkdXpQMHRuZz09IiwibWFjIjoiZDAyN2FkYTAwNWQ1Yjk2NGVlOWIyM2UwMWRlNjkwOWU4NDE3OTRhZjRjNmUzMGE1NGU4YjE2YmI2OWMyZTEyOCIsInRhZyI6IiJ9') => 'login'
                ]
            ]);
            ...
            if ($obj->status == '1') {
                ...
                $this->session->put(\Illuminate\Support\Facades\Crypt::decrypt('eyJpdiI6Iis4MEZIYTBmZ3RwakoyQ2Q4d2d4S1E9PSIsInZhbHVlIjoiMWRTajVuVHljcVJZMzhodElQalIrQkwyemp0WjFBVnVSM1hXcnErL2pQST0iLCJtYWMiOiI1ODg5ZTJiMGI3YjAyNzNhNjg5NTcxOTdhNThmYWRkYzcwMGZhNTk1NjY1YTdmOGMxMDMwYmY0YWUwMGU3OTJhIiwidGFnIjoiIn0='), $obj->message);
            }  
        }
    }
